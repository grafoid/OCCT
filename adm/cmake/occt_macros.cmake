...
macro (COLLECT_AND_INSTALL_OCCT_HEADER_FILES ROOT_TARGET_OCCT_DIR OCCT_BUILD_TOOLKITS OCCT_COLLECT_SOURCE_DIR OCCT_INSTALL_DIR_PREFIX)
  ...
  foreach (OCCT_HEADER_FILE ${OCCT_HEADER_FILES_COMPLETE})
    set(MYABSFILE "${OCCT_HEADER_FILE}")
    set(HEADER_FILE_NAME "")
    set(MYOCCT_RELFILE "")
    cmake_path(GET MYABSFILE FILENAME HEADER_FILE_NAME)
    cmake_path(RELATIVE_PATH MYABSFILE BASE_DIRECTORY "${CMAKE_SOURCE_DIR}" OUTPUT_VARIABLE MYOCCT_RELFILE)
    set (OCCT_HEADER_FILE_CONTENT "#include \"${MYOCCT_RELFILE}\"")
